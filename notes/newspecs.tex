...
\noindent\begin{tabular}{l r r l}
    ...
    Coercions    & $c$      & $::=~$ & $\idC{\rho}~\mid~\topC{\rho}~\mid~\topArrC~\mid~\topAllC~\mid~\distArrC{\rho_1}{\rho_2}{\rho_3}~\mid~\projlC{\rho_1}{\rho_2}~\mid~\projrC{\rho_1}{\rho_2}~\mid$\vspace{0.1cm}\\
                 &          & & $\mpC{c_1}{c_2}~\mid~\compC{c_1}{c_2}~\mid~\pairC{c_1}{c_2}~\mid~\arrC{c_1}{c_2}~\mid~\textcolor{magenta}{\alllC{c}{\rho}}~\mid~\textcolor{magenta}{\allrC{\alpha}{c}}$\vspace{0.3cm}\\
...
\fbox{
  \begin{mathpar}
    ...
    \inferrule*[right=U-VVL]{\wfSubst{\Delta}{\unification{\alpha}{\hat\beta}}{\theta}}{\unifyB{\Delta}{\hat\alpha}{\hat\beta}{{\hat\alpha}\mapsto{\hat\beta},\,\theta}} \and
    \inferrule*[right=U-VVR]{\wfSubst{\Delta}{\unification{\beta}{\hat\alpha}}{\theta}}{\unifyB{\Delta}{\hat\alpha}{\hat\beta}{{\hat\beta}\mapsto{\hat\alpha},\,\theta}} \and
