...
\fbox{
  \begin{mathpar}
    ...
    \inferrule*[right=D-TopR]{ }{\disjoint{\Delta}{A}{\top}} \\
...
%    \inferrule{\disjoint{\Delta}{A}{B}}{\disjoint{\Delta}{\trecord{l}{A}}{\trecord{l}{B}}} \and
    %% \inferrule{l_1\neq l_2}{\disjoint{\Delta}{\trecord{l_1}{A}}{\trecord{l_2}{B}}}\\
    \mprset{sep=1em}
    ...
    %% \inferrule*[right=D-All]{\disjoint{\Delta,\tentry{\alpha}{A_1\& B_1}}{A_2}{B_2}}{\disjoint{\Delta}{\Tabs{\alpha}{A_1}{A_2}}{\Tabs{\alpha}{B_1}{B_2}}} \and
    \inferrule*[right=]{\starax{A}{B}}{\disjoint{\Delta}{A}{B}}
  \end{mathpar}
}
\subsection{Notes}
...
\subsubsection{Subsumption of \textsc{S-DistAll} and \textsc{S-topAll} from $F_{i}^{+}$}
...
\begin{table}[h]
  \begin{tabular}{l r r l}
    ...
    Coercion context & $\mathcal{C}$ & $::=$ & $\bullet~\mid~\arrCC{\mathcal{C}}{c}$\vspace{0.3cm}\\%\abs{c}{\mathcal{C}}~\mid~\mid~\pair{\mathcal{C}}{e}~\mid~\pair{e}{\mathcal{C}}~\mid~\record{l}{\mathcal{C}}~\mid~$\vspace{0.1cm}\\
                  %% &          &       & $\textcolor{magenta}{\tabs{\alpha}{A}{\mathcal{C}}}~\mid~\textcolor{magenta}{\tabs{\hat\alpha}{A}{\mathcal{C}}}~\mid~\textcolor{magenta}{\mathcal{C}\,A}$\vspace{0.3cm}\\
    Type variable substitutions & $\theta$ & $::=$ & $\bullet~\mid~\unification{\alpha}{A},\theta~\mid~\substitution{\alpha}{A},\theta$\vspace{0.3cm}\\
    %% Unification variable substitutions & $\theta$ & $::=$ & $\bullet~\mid~\substitution{\alpha}{A},\theta$
  \end{tabular}
...
\begin{minipage}[t]{0.5\textwidth}
  ...
  \begin{align*}
    ...
    %% [\unification{\alpha}{\tau}](\Tabs{\hat\beta}{A}{B}) &= \Tabs{\hat\beta}{[\unification{\alpha}{\tau}]A}{[\unification{\alpha}{\tau}]B}\\
...
\begin{minipage}[t]{0.5\textwidth}
  ...
  \begin{align*}
    ...
    %% [\unification{\alpha}{\tau}]\tabs{\hat\beta}{A}{E} &= \tabs{\hat\beta}{[\unification{\alpha}{\tau}]A}{[\unification{\alpha}{\tau}]E}\\
    [\unification{\alpha}{\tau}](E\,A) &= ([\unification{\alpha}{\tau}]E)\, ([\unification{\alpha}{\tau}]A)
  \end{align*}
\end{minipage}\\
...
\begin{minipage}[t]{0.47\textwidth}
  ...
  \end{align*}
  %% \mypar{\large{...on coercion contexts}}
  %% \begin{align*}
  %%   [\unification{\alpha}{\tau}]\bullet &= \bullet\\
  %%   [\unification{\alpha}{\tau}]\abs{c}{\mathcal{C}} &= \abs{c}{[\unification{\alpha}{\tau}]\mathcal{C}}\\
  %%   [\unification{\alpha}{\tau}](\mathcal{C}\,e) &= ([\unification{\alpha}{\tau}]\mathcal{C})\, ([\unification{\alpha}{\tau}]e)\\
  %%   [\unification{\alpha}{\tau}](e\,\mathcal{C}) &= ([\unification{\alpha}{\tau}]e)\, ([\unification{\alpha}{\tau}]\mathcal{C})\\
  %%   [\unification{\alpha}{\tau}]\pair{\mathcal{C}}{e} &= \pair{[\unification{\alpha}{\tau}]\mathcal{C}}{[\unification{\alpha}{\tau}]e}\\
  %%   [\unification{\alpha}{\tau}]\pair{e}{\mathcal{C}} &= \pair{[\unification{\alpha}{\tau}]e}{[\unification{\alpha}{\tau}]\mathcal{C}}\\
  %%   [\unification{\alpha}{\tau}]\record{l}{\mathcal{C}} &= \record{l}{[\unification{\alpha}{\tau}]\mathcal{C}}\\
  %%   [\unification{\alpha}{\tau}]\tabs{\alpha}{A}{\mathcal{C}} &= \tabs{\alpha}{[\unification{\alpha}{\tau}]A}{[\unification{\alpha}{\tau}]\mathcal{C}}\\
  %%   [\unification{\alpha}{\tau}]\tabs{\hat\beta}{A}{\mathcal{C}} &= \tabs{\hat\beta}{[\unification{\alpha}{\tau}]A}{[\unification{\alpha}{\tau}]\mathcal{C}}\\
  %%   [\unification{\alpha}{\tau}](\mathcal{C}\,A) &= ([\unification{\alpha}{\tau}]\mathcal{C})\, ([\unification{\alpha}{\tau}]A)
  %% \end{align*}
...
\begin{minipage}[t]{0.5\textwidth}
  ...
  \begin{align*}
    ...
    [{\alpha}\mapsto{\tau}](A\to B)              &= ([\substitution{\alpha}{\tau}]A)\to([\unification{\alpha}{\tau}]B)\\
    [{\alpha}\mapsto{\tau}](A\& B)               &= ([\substitution{\alpha}{\tau}]A)\&([\unification{\alpha}{\tau}]B)\\
    [{\alpha}\mapsto{\tau}](\Tabs{\alpha}{A}{B}) &= \Tabs{\alpha}{[\substitution{\alpha}{\tau}]A}{[\substitution{\alpha}{\tau}]B}\\
    %% [{\alpha}\mapsto{\tau}](\Tabs{\hat\beta}{A}{B}) &= \Tabs{\hat\beta}{[\substitution{\alpha}{\tau}]A}{[\substitution{\alpha}{\tau}]B}\\
...
\begin{minipage}[t]{0.5\textwidth}
  ...
  \begin{align*}
    ...
    %% [\substitution{\alpha}{\tau}]\tabs{\hat\alpha}{A}{E} &= \tabs{\hat\alpha}{[\substitution{\alpha}{\tau}]A}{[\substitution{\alpha}{\tau}]E}\\
    [\substitution{\alpha}{\tau}](E\,A) &= ([\substitution{\alpha}{\tau}]E)\, ([\substitution{\alpha}{\tau}]A)
  \end{align*}
\end{minipage}\\
...
\begin{minipage}[t]{0.47\textwidth}
  ...
  %% \end{align*}
\end{minipage}\vspace{3pt}
\subsubsection{Completing coercion contexts}
\begin{minipage}[t]{0.47\textwidth}
\begin{align*}
  \bullet [c] &= c\\
  ...
  (\mpCC{\mathcal{C}}{\mathcal{M}}{c_1}{c_2}{A}{B})[c] &= \ldots
\end{align*}
\end{minipage}
...
\begin{mathpar}
  ...
  \inferrule*[right=WFS-next]{\wfSubst{\Delta}{\theta}{\theta_1} \\ \theta_1\circ\theta(\algdisjoint{\Delta}{A}{B)}{\theta_2}}{\wfSubst{\Delta,\tentry{\hat{\alpha}}{B}}{\theta,\unification{\alpha}{A}}{\theta_1\circ\theta_2}}
\end{mathpar}
}
\mypar{Unification algorithm}
\fbox{
  \begin{mathpar}
    \inferrule*[right=U-refl]{ }{\unifyB{\Delta}{\xi}{\xi}{\bullet}} \and
  ...
  \begin{subfigure}{\textwidth}
    \begin{mathpar}
      ...
      \inferrule*[right=AR-base]
          {\algSubLeft{\Delta}{\mathcal{L}}{\bullet}{A}{\abs{c}{c}}{A}{\xi}{\mathcal{C}}{\theta}}
  ...
  \begin{subfigure}{\textwidth}
    \begin{mathpar}
      ...
      \inferrule*[right=AL-VarArr]
                 {\theta= [\unification{\alpha}{(\hat\alpha_1\to\hat\alpha_2)}] \\ \fresh{\hat\alpha_1, \hat\alpha_2}\\
                   \algSubRight{\theta(\Delta)}{\bullet}{\theta'(B_1)}{\hat\alpha_1}{c_1}{\theta_1}\\
                   \theta_1\circ\theta(\algSubLeft{\Delta}{\mathcal{L}}{\mathcal{M},B_1}{A_0}{\abs{c}{\mathcal{C}[\arrC{c_1}{c}]}}{\hat\alpha_2}{\xi}{\mathcal{C'}}{\theta_2})
                 }
      ...
      \inferrule*[right=AL-AndL]
          {\algSubLeft{\Delta}{\mathcal{L}}{\mathcal{M}}{A_0}{\abs{c}{\mathcal{C}[\compC{c}{\projlC{\toTarget{A_1}}{\toTarget{A_2}}}]}}{A_1}{\xi}{\mathcal{C'}}{\theta}}
          {\algSubLeft{\Delta}{\mathcal{L}}{\mathcal{M}}{A_0}{\mathcal{C}}{A_1\& A_2}{\xi}{\mathcal{C'}}{\theta}}
      \and
      \inferrule*[right=AL-AndR]
          {\algSubLeft{\Delta}{\mathcal{L}}{\mathcal{M}}{A_0}{\abs{c}{\mathcal{C}[\compC{c}{\projrC{\toTarget{A_1}}{\toTarget{A_2}}}]}}{A_2}{\xi}{\mathcal{C'}}{\theta}}
          {\algSubLeft{\Delta}{\mathcal{L}}{\mathcal{M}}{A_0}{\mathcal{C}}{A_1\& A_2}{\xi}{\mathcal{C'}}{\theta}}
      \and
      \inferrule*[right=AL-Arr]
          {\algSubRight{\Delta}{\bullet}{B_1}{A_1}{c_1}{\theta_1}\\ \theta_1(\algSubLeft{\Delta}{\mathcal{L}}{\mathcal{M},B_1}{A_0}{\abs{c}{\mathcal{C}[\arrC{c_1}{c}]}}{A_2}{\xi}{\mathcal{C'}}{\theta})}
      ...
      \inferrule*[right=AL-MP]
                 {\algSubRight{\Delta}{\bullet}{A_0}{\arrowqueue{\mathcal{M}}{A_1}}{c_1}{\theta_1}\\
                  \theta_1(\algSubLeft{\Delta}{\mathcal{L}}{\mathcal{M}}{A_0}{\mathcal{C'}}{A_2}{\xi}{\mathcal{C''}}{\theta_2})\\
      ...
      \inferrule*[right=AL-Forall]
                 {\algSubLeft{\Delta,\tentry{\hat{\alpha}}{A}}{\mathcal{L}}{\mathcal{M}}{A_0}{\abs{c}{\mathcal{C}[\alllC{c}{\hat\alpha}]}}{[\alpha\mapsto\hat{\alpha}]B}{\xi}{\mathcal{C'}}{\theta}\\
                 \fresh{\hat\alpha}}
