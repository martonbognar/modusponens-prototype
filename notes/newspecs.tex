...
\begin{align*}
  ...
  \mpCC{\mathcal{C}}{\mathcal{M}}{c_1}{A}{B}[c] &= \ldots
\end{align*}
\end{minipage}
  ...
  \begin{subfigure}{\textwidth}
    \begin{mathpar}
      ...
      \inferrule*[right=AL-VarArr]
                 {\theta= [\unification{\alpha}{(\hat\alpha_1\to\hat\alpha_2)}] \\ \fresh{\hat\alpha_1, \hat\alpha_2}\\ (\tentry{\hat\alpha}{A})\in\Delta\\\\
                   \algSubRight{\theta(\Delta,\tentry{\hat\alpha_1}{\top},\tentry{\hat\alpha_2}{A})}{\bullet}{\theta'(B_1)}{\hat\alpha_1}{c_1}{\theta_1}\\
